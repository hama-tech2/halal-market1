...
const TX = {
  ...
  ar:{ eyebrow:'أربيل · كوردستان', sub:'كل مستلزمات المنزل والحياة بأفضل الأسعار، جودة عالية وعروض أسبوعية في حلال ماركت.', btn1:'العروض', btn2:'فروعنا',
    promoTitle:'العروض', promoSub:'أحدث الأسعار', mAll:'الكل', m1:'حلال ماركت ١', m2:'حلال ماركت ٢', m3:'حلال ماركت الأوسط', m4:'حلال ماركت ٤', newPost:'عرض جديد', feedEmpty:'لا توجد عروض بعد', seeMore:'عرض المزيد', seeLess:'عرض أقل', cdD:'يوم', cdH:'ساعة', cdM:'دقيقة', cdS:'ثانية', cdEnded:'انتهى العرض', commented:'علّقوا', notifNew:'عرض جديد أُضيف! 🏷️', notifSoon:'خصم جديد قريباً. ترقّبوا! 🔔', shareText:'شاهد هذا العرض!', linkCopied:'تم نسخ الرابط! ✓', soonBadge:'قريباً', discBadge:'خصم', langCode:'AR', soonStart:'يبدأ', feat1t:'الجودة', feat1l:'اختيار دقيق للمنتجات', feat1p:'طازج كل يوم', feat2t:'العروض', feat2l:'عروض جديدة كل أسبوع', feat2p:'أسبوعياً', feat3t:'الثقة', feat3l:'خدمة موثوقة ونظيفة', feat3p:'موثوق',
...
function showNotifToast(){
  ...
  const msg=(newest&&newest.post_type==='soon')
    ? (TX[lang].notifSoon||TX[lang].notifNew)
    : TX[lang].notifNew;
  st('notif-toast-txt', msg || 'داشکاندنی نوێ!');
